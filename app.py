...
app = Flask(__name__)
app.secret_key = "sohbet_final_v4_2026"
DB = "sohbet_v4.db"
...
<head>
    <meta charset="UTF-8">
    <title>Görüntülü Arama v4</title>
    ...
    <style>
        ...
        .sidebar { width: 300px; background: #1a1e23; border-right: 1px solid #333; padding: 20px; }
        ...
        #modal { display: none; position: fixed; top: 30%; left: 50%; transform: translate(-50%, -50%); background: #fff; color: #000; padding: 30px; border-radius: 10px; text-align: center; z-index: 1000; }
...
<body>
    <div id="modal">
        ...
        <button onclick="rejectCall()" style="background:red; color:white; padding:10px 20px;">Reddet</button>
    </div>
    ...
    <div class="main">
        ...
        <div style="margin-top:20px;">
            <button onclick="endCall()" id="endBtn" class="cancel-btn" style="display:none;">📞 Aramayı Kapat</button>
    ...
    <script>
        ...
        navigator.mediaDevices.getUserMedia({ video: true, audio: true }).then(stream => {
            ...
            peer.on('call', call => {
                ...
                // --- İki Taraflı Kapatma Dinleyicisi ---
